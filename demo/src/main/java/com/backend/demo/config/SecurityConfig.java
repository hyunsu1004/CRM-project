        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/api/login", "/", "/api/signup", "/signup/email", "/signup/email", "/signup/emailAuth","/crawl","/api/company","/api/attribute","/api/user/attribute","api/user/attributes","/api/{attributeId}",
                                ...
                                "/api/member/deals/{id}","api/member/deals/notes/{dealId}","/api/notes/{dealId}", "/api/member/{memberId}/deals", "/api/member/{memberId}/deals/addattributes", "/api/member/{memberId}/deals/addattributes", "/api/member/{memberId}/deals/{dealId}/attributes/{attributeId}/addValue", "/api/member/adddeals",
                                "/api/member/deals/{dealId}/{noteId}","/api/member/deals/${selectedIds}","/api/member/deals/{noteId}","/api/member/deals/${dealId}/notes").permitAll()
